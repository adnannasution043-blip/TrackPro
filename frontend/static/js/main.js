...
async function _initSidebarFilter() {
  ...
  try {
    ...
    // Sub-akun Meta per Shopee dihapus dari sini — sekarang sudah ada
    // dropdown Meta khusus di halaman Iklan (scoped ke Shopee yang aktif),
    // jadi panel ini cukup pilih Shopee atau Meta secara flat.
