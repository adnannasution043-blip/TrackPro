...
class AduSyncLog(Base):
    __tablename__ = "adu_sync_logs"

    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    adu_account_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("adu_accounts.id", ondelete="CASCADE"), nullable=False
    )
